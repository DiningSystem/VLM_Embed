...
from transformers import AutoConfig, AutoModelForCausalLM, Cache, Qwen2Config
...
@dataclass
class LlavaQwen2OutputWithPast(ModelOutput):
...
class LlavaQwen2ForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            # print(f"Batch size of input_ids: {input_ids.shape[0]}")
            (
                input_ids,
                position_ids,
                attention_mask,
