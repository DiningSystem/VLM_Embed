#!/bin/bash
# Train MPS trên cả CLS task và VQA task (MMEB-train).
# - CLS: ImageNet_1K, N24News, HatefulMemes, VOC2007, SUN397
# - VQA: OK-VQA, A-OKVQA, DocVQA, InfographicsVQA, ChartQA, Visual7W
#
# MPS 2-epoch: Epoch 1 train RedundancyEstimator, Epoch 2 train synergy/magnitude/orth + contrastive.
...
SUBSETS_CLS=("ImageNet_1K" "N24News" "HatefulMemes" "VOC2007" "SUN397")
# VQA subsets
SUBSETS_VQA=("OK-VQA" "A-OKVQA" "DocVQA" "InfographicsVQA" "ChartQA" "Visual7W")
...
deepspeed --num_gpus=$NUM_GPUS $TRAIN_SCRIPT \
    ...
    --subset_name "${SUBSETS_CLS[@]}" "${SUBSETS_VQA[@]}" \
    --dataset_split "original" \
    --image_dir "vlm2vec_train/MMEB-train" \
    --percent_data 0.3 \
    --output_dir "training/mps_2epoch_cls_vqa" \
